...
import org.carlook.gui.windows.GenderSelectWindow;
...
public class ProfilePage extends VerticalLayout implements View {
    ...
    /**
     * Repräsentiert die Profilseite mit der Möglichkeit
     * diverse Userinformationen zu bearbeiten
     */
        ...
        save.addClickListener(clickEvent -> {
            try {
                if (!anredeSelect.isEmpty()) {
                    RegistrationControl.updateAnrede(user, anredeSelect.getValue());
                }

                if (!name.getValue().isEmpty()) {
                    RegistrationControl.updateName(user, name.getValue());
                }


                if (!prename.getValue().isEmpty()) {
                    RegistrationControl.updatePrename(user, prename.getValue());
                }
