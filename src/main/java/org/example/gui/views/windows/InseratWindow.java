...
public class InseratWindow extends Window {
    ...
    public InseratWindow(Vertriebler vertriebler) {
        ...
        inseriere.addClickListener(clickEvent -> {
            try {
                InseratControl.inseriere(vertriebler, carID.getValue(), marke.getValue(), baujahr.getValue(), beschreibung.getValue(),
                        ps.getValue(), verbrauch.getValue(), preis.getValue());
